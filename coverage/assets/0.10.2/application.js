...
(function (a, b) {
    ...
    var bB = /%20/g, bC = /\[\]$/, bD = /\r?\n/g, bE = /#.*$/, bF = /^(.*?):[ \t]*([^\r\n]*)\r?$/mg,
        ...
        bO = /([?&])_=[^&]*/, bP = /^([\w\+\.\-]+:)(?:\/\/([^\/?#:]*)(?::(\d+))?)?/, bQ = f.fn.load, bR = {}, bS = {},
        bT, bU;
    try {
        bT = e.href
    } catch (bV) {
...
(function (j, Y, p) {
    ...
    m.oPagination = {
        two_button: {
            ...
            fnInit: function (g, l, q) {
                var r = p.createElement("span"), u = p.createElement("span"), y = p.createElement("span"),
                    C = p.createElement("span"), w = p.createElement("span");
                r.innerHTML =
            ...
            fnUpdate: function (g, l) {
                if (g.aanFeatures.p) {
                    var q = m.oPagination.iFullNumbersShowPages, r = Math.floor(q / 2),
                        u = Math.ceil(g.fnRecordsDisplay() / g._iDisplayLength),
                        y = Math.ceil(g._iDisplayStart / g._iDisplayLength) + 1, C = "", w, x = g.oClasses;
                    if (u < q) {
                        r = 1;
                        w = u
                    } else if (y <= r) {
    ...
    j.fn.dataTable = function (g) {
        ...
        function ua(a) {
            ...
            var b = p.createElement("div"), c = p.createElement("div"), d = p.createElement("div"),
                f = p.createElement("div"), e = p.createElement("div"), i = p.createElement("div"),
                h = a.nTable.cloneNode(false), k = a.nTable.cloneNode(false),
                o = a.nTable.getElementsByTagName("thead")[0], t = a.nTable.getElementsByTagName("tfoot").length ===
                0 ? null : a.nTable.getElementsByTagName("tfoot")[0],
                s = typeof g.bJQueryUI != "undefined" && g.bJQueryUI ? m.oJUIClasses : m.oStdClasses;
            c.appendChild(d);
            e.appendChild(i);
        ...
        function xa(a) {
            var b = a.nScrollHead.getElementsByTagName("div")[0], c = b.getElementsByTagName("table")[0],
                d = a.nTable.parentNode, f, e, i, h, k, o, t, s, H = [];
        ...
        function Ca(a) {
            if (!(!a.oFeatures.bInfo || a.aanFeatures.i.length === 0)) {
                var b = j(a.aanFeatures.i[0]), c = a.fnFormatNumber(a.fnRecordsTotal()),
                    d = a.fnFormatNumber(a._iDisplayStart + 1), f = a.fnFormatNumber(a.fnDisplayEnd()),
                    e = a.fnFormatNumber(a.fnRecordsDisplay());
        ...
        function ra(a) {
            ...
            j("select", f).change(function () {
                ...
                if (a._iDisplayLength ==
                    -1) a._iDisplayStart = 0;
                D(a)
            });
            return f
        }

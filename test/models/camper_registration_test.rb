...
class CamperRegistrationTest < ActiveSupport::TestCase
  ...
  context 'within context' do
    ...
    should 'show that campers cannot be registered at the two camps at the same time' do
      create_generic_user
      create_users
      create_generic_parent
      create_parents
      ...
      registration1 = FactoryBot.create(:camper_registration, camp: @first_term, camper: @alex)
      registration2 = FactoryBot.build(:camper_registration, camp: @ldp_boys, camper: @alex)
